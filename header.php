...
<html>
<head>
<title>Best Place For Grocery Products </title>
<!-- for-mobile-apps -->
...
<!-- header -->
	<div class="agileits_header">
		<div class="w3l_offers">
			<a href="products.php">TODAYS OFFER</a>
		</div>
      ...
      echo '<div class="w3l_header_right">
			<ul>
				<li class="dropdown profile_details_drop">
					...
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user " aria-hidden="true">MY Account</i><span class="caret"></span></a>
    ...
    echo '<div class="w3l_header_right">
			<ul>
				<li class="dropdown profile_details_drop">
					...
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user " aria-hidden="true"> SIGNUP</i><span class="caret"></span></a>
					<div class="mega-dropdown-menu">
						<div class="w3ls_vegetables">
							<ul class="dropdown-menu drp-mnu">
	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="main.php"><span>Grocery</span> Store</a></h1>
			</div>
...
<!-- products-breadcrumb -->
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				<li><i class="fa fa-home" aria-hidden="true"></i><a href="main.php">Home</a><span>|</span></li>
